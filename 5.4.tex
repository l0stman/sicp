...
\begin{datapath}
  ...
  \draw (val.south east) [->] |- (mul.north west);
  \draw (b.north east) [->] |- (mul.south west);
...
\begin{datapath}
  ...
  (counter);
  \draw[->] (product.south east) -- (product.south east -| mul.west);
  \draw[->] (b.north east) -- (b.north east -| mul.west);
  \draw[->] (mul.east) -| (update product) -| (product.north east);
\end{datapath}
